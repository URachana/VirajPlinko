...
function draw() {
 ...
 if( particle !== undefined && particle !== null){
    ...
    if(particle.body.position.y>700 ){
      ...
      else if(particle.body.position.x>485 && particle.body.position.x<555){
        score= score+200;
        console.log(score);
        particle= null;
      
      }
      else if(particle.body.position.x>565 && particle.body.position.x<635){
        score= score+200;
        console.log(score);
        particle = null;
        
      }
      else if(particle.body.position.x>645 && particle.body.position.x<715){
        score= score+500;
        console.log(score);
        particle = null;
        
      }
      else if(particle.body.position.x>725 && particle.body.position.x<795){
        score= score+500;
        console.log(score);
        particle = null;
